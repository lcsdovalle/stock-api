...
from api.settings import VENON_BOT_ENDPOINT
...
class WhatsappAPIView(APIView):
    ...
    def post(self, request: Request):
        """This is going to start a session on venon service"""
        try:
    ...
    def get(self, request: Request, *args, **kwargs):
        """This is going to check if the qr code the session is available"""
